...
class _$_UserModel implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(userId: $userId, userName: $userName, email: $email, iconImagePath: $iconImagePath, area: $area, introduction: $introduction, age: $age, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userId, userName, email,
      iconImagePath, area, introduction, age, createdAt, updatedAt);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      @UpdatedAtField() final DateTime? updatedAt}) = _$_UserModel;
